...
" Theme
set termguicolors			" Idk, it says to do it
colorscheme catppuccin_mocha		" Set colorscheme
hi Normal guibg=NONE ctermbg=NONE	" Remove background colours from colorscheme
